    ...
    def AdicionarUnicaCarta(self, carta, local = 'inicio'):
        if self.__isEmpty():
            ...
            if local == 'fim':
                ...
                self.__cartas.insert(len(self.cartas), carta)
...
def Menu(baralho):
    ...
    while True:
        ...
        if opcao_escolhida == '1':
            ...
            carta_valor = input('> Digite o valor da carta: ')
            carta_naipe = input('> Digite o naipe da carta: ')
            baralho.AdicionarUnicaCarta(Carta(carta_valor, carta_naipe))
        elif opcao_escolhida == '9':
            print('## ADICIONAR CARTA NO FIM DO BARALHO')
            carta_valor = input('> Digite o valor da carta: ')
            carta_naipe = input('> Digite o naipe da carta: ')
            baralho.AdicionarUnicaCarta(Carta(carta_valor, carta_naipe), 'fim')
